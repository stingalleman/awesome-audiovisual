...
- [OBS-VirtualCam](https://github.com/CatxFish/obs-virtual-cam) - `✓ open-source` OBS-VirtualCam is a plugin for obs-studio , transforming the output video to a virtual directshow device.
